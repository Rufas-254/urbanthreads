...
JAZZMIN_SETTINGS = {
    # Site branding
    'site_header': "UrbanThreads",
    'site_brand': "UrbanThreads Luxury",  
    'site_title': "UrbanThreads Admin",
    'login_logo': None,
    'site_logo': None,
    'copyright': "UrbanThreads Ltd",
    'welcome_sign': "Welcome to UrbanThreads Admin Portal",
    ...
    # UI Tweaks - Luxury Burgundy Theme
    "ui_tweaks": {
